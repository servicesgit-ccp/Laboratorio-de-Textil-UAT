...
class TestTypesSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $types = [
            ...
            ['name_es' => 'AATCC179', 'name_en' => 'AATCC179', 'description' => 'AATCC 179 - torsión'],
            ['name_es' => 'ASTM D3776', 'name_en' => 'ASTM D3776', 'description' => 'ASTM D3776 - masa por unidad de área'],
            ['name_es' => 'ASTM D3512', 'name_en' => 'ASTM D3512', 'description' => 'ASTM D3512 - pilling'],
            ['name_es' => 'AATCC8', 'name_en' => 'AATCC8', 'description' => 'AATCC 8 - absorción/pickup húmedo-seco'],
            ['name_es' => 'AATCC81', 'name_en' => 'AATCC81', 'description' => 'AATCC 81 - ph y tolerancias'],
            ['name_es' => 'ASTMD2261', 'name_en' => 'ASTMD2261', 'description' => 'ASTM D2261 - resistencia lb/f (urdimbre/trama)'],
            ['name_es' => 'ASTMD5034', 'name_en' => 'ASTMD5034', 'description' => 'ASTM D5034 - resistencia y promedio urdimbre/trama'],
            ['name_es' => 'AATCC61', 'name_en' => 'AATCC61', 'description' => 'ASTM D5034 - resistencia y promedio urdimbre/trama'],
